...
```bash
ls experiments/antonio/resnet50_warmup/
# Debe contener:
...
git add src/ configs/
git add experiments/antonio/resnet50_warmup/metrics.json
git add experiments/antonio/resnet50_warmup/classification_report.txt
git add experiments/antonio/resnet50_warmup/model_summary.txt
git add experiments/antonio/resnet50_warmup/figures/
git add experiments/all_results.csv

git commit -m "feat(antonio): resnet50 warmup — recall=0.9712, f1=0.9534"
git push origin feature/antonio/resnet-warmup
```
